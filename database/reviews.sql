...
crow12345
*/
    (1, 'Yuan', 'yuan@email.com', '$2y$10$u/cKuA3QWYm3u.nDewpY2OvgMm5TCg0D4N75w0PsxVx5l0ughMxcW'),
    (2, 'Romyr', 'romyr@email.com', '$2y$10$0tERpyr4tvA8qUdWTq1KBu58OWw/sPr13.8oVvz2ByQn61Cck4AAW'),
    (3, 'Angel', 'angel@email.com', '$2y$10$GAc1nlJsLUm8ZzPk.zF4Q.m3JWhZnlKfkMmveRhGmC1lW0R0SY4Iq'),
    (4, 'JB_Aparicio', 'jbaparicio@email.com', '$2y$10$TqK5xISlId763rkGm8WXU.jtIgHVo9uetVFk74Wr5wJlt4Y5I0ca2'),
    (5, 'Crow', 'crow@email.com', '$2y$10$dDHUw2AfU20a5ZR9T3CAVeCUOCSuKgO4I3WIYkG4zfDQHDjh1M83i');
...
VALUES
    ...
    (5, 2, 5, 'Lifechanging', 1, 12),
    (5, 3, 2, 'Could be better...', 0, 5);
...
VALUES
    ...
    (5, 1, 4, 'Brings back memories!', 1, 4),
    (5, 4, 5, 'A classic banger!!!', 1, 3);
